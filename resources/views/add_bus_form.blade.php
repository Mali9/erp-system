...
<center>
	<form  role="form" method="POST" action="{{ url('/add_bus_submit') }}" enctype="multipart/form-data">
                 ...
                 <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                رقم الاتوبيس   <input style="width:40%;" id="number" placeholder="bus_number" type="text" class="text2{{ $errors->has('number') ? ' is-invalid' : '' }}" name="number" value="{{ old('number') }}" required autofocus><br>
